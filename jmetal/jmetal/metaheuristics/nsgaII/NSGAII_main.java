...
public class NSGAII_main {
   ...
   */
  public static void main(String cost_file, int amount, int numberOfFeatures, int productsInProductLine) throws 
                                  JMException, 
                                  SecurityException, 
                                  IOException, 
...
//  logger_.info("Objectives values have been writen to file FUN");
    ...
    ProductSolution.print(population.solutionsList_, "NSGAII", amount, numberOfFeatures);
